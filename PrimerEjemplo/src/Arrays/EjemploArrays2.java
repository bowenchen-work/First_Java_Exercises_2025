...
public class EjemploArrays2 {
    public static void main(String[] args) {
        ...
        //1º: Recorrer el array mostrando todos los valores. Un en cada línea
        //2º: Recorrer el array (en otro bucle distinto) y queremos hacer LA MEDIA de las notas
        //3º: Recorrer el array hasta que encontremos una npta que sea igial a 10.
        //(si la nota es igual a 10, el bucle deberia detenerse)
    }
}
